...
const TimerCard = ({ onTimerSet }: TimerCardProps) => {
  ...
  return (
    <div className="timer-card">
        ...
        <div className="timer-inputs-container">
          <div className="hour-column">
            ...
            <input
              type="number"
              value={hours}
              onChange={(e) => handleInputChange(setHours, 23, e.target.value)}
            />
            <button
              className="minus-btn"
              onClick={() => decrement(setHours, 23, hours)}
            >
              -
            </button>
          </div>
          ...
          <div className="minute-column">
            ...
            <input
              ...
              value={minutes}
              onChange={(e) =>
                handleInputChange(setMinutes, 59, e.target.value)
              }
            />
            <button
              className="minus-btn"
              onClick={() => decrement(setMinutes, 59, minutes)}
            >
              -
            </button>
          </div>
      ...
      <button className="side-btn" onClick={handleSubmit}>
